      ...
      <Table striped>
        ...
        <tbody>
          <tr>
            ...
            <td className="wd-login-id">003215592S</td>
        ...
        <tbody>
          <tr>
            ...
            <td className="wd-login-id">004819572S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-10-04</td>
            <td className="wd-total-activity">7:02:32</td>
          </tr>
        </tbody>
        <tbody>
          <tr>
            ...
            <td className="wd-login-id">002352424S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">TA</td>
            <td className="wd-last-activity">2020-10-03</td>
            <td className="wd-total-activity">9:40:32</td>
          </tr>
        </tbody>
      </Table>
    </div>
